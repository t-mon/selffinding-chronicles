...
void PlayerController::setPlayer(Character *player)
{
    ...
    if (player) {
        qCDebug(dcPlayerController()) << "Player set" << player;
    } else {
        qCDebug(dcPlayerController()) << "Player reset";
    }
...
void PlayerController::keyPressed(const Qt::Key &key)
{
    ...
    case Qt::Key_B:
        ...
        break;
    case Qt::Key_1:
        qCDebug(dcPlayerController()) << "Weapon button pressed";
        emit weaponPressed();
        break;
    case Qt::Key_2:
        qCDebug(dcPlayerController()) << "Firearm button pressed";
        emit firearmPressed();
        break;
    default:
        break;
