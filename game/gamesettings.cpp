...
GameWindow::Visibility GameSettings::visibility() const
{
    return m_visibility;
}

void GameSettings::setVisibility(GameWindow::Visibility visibility)
{
...
void GameSettings::loadSettings()
{
    ...
    m_visibility = static_cast<GameWindow::Visibility>(m_settings->value("visibility", GameWindow::Windowed).toInt());
    emit visibilityChanged(m_visibility);
